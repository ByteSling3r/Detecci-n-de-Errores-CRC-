...
data_label = tk.Label(window, text="Enter data you want to send:")
data_label.pack()
data_entry = tk.Entry(window)
data_entry.pack()

key_label = tk.Label(window, text="Enter a Generator:")
key_label.pack()
key_entry = tk.Entry(window)
key_entry.pack()

# Create buttons
calculate_crc_button = tk.Button(window, text="Calculate CRC and TX", command=calculate_crc)
